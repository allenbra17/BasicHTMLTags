let soundBite = document.querySelector('#myAudio')
...
raceButton.addEventListener('click', () => {
    ...
    let randomNumOne = getRandomNumber(1, 5);
    let randomNumTwo = getRandomNumber(1, 5);
